...
def merge_configs(configs: List[Dict]) -> Dict:
    ...
    for config in configs:
        merged_config = update_merge(merged_config, config)
...
a = {'type_': 'flair', 'batch_size': 10, 'bla': ['a', 'b', 'c']}
b = {'type_': 'flair', 'batch_size': 30}
c = {'type_': 'flair', 'batch_size': 50}

merged_conf = merge_configs([a, b, c])

print(merged_conf)

reformat_config(merged_conf)
